...
const ConfirmDelete: React.FC<ConfirmDeleteProps> = ({
    ...
    if (isModal) {
        return (
            ...
            >
                <motion.div
                    className="absolute inset-0 mx-2 h-full flex justify-center items-center"
                        ...
                        {spaceOrTask === 'task' ? (
                            <>
                                ...
                                >
                                    ...
                                    <span className="italic">
                                        {(objectToDelete as Task).taskName
                                            .length > 15
                                            ? (
                                                  objectToDelete as Task
                                ...
                                <p className="mb-4" style={textColorStyle}>
                                    Deleting this task will also delete all of
                                    its subtasks.
                                </p>
                            ...
                            <>
                                ...
                                >
                                    Delete{' '}
                                    <span className="italic">
                                        {(objectToDelete as SpaceData).name
                                            .length > 15
                                            ? (
                                ...
                                <p
                                    ...
                                    style={textColorStyle}
                                >
                                    All tasks in the space will also be deleted.
